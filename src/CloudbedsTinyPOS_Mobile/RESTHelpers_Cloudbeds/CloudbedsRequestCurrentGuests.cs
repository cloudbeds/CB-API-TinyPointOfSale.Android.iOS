...
/// <summary>
/// A request to get the dashboard data from Cloudberds
/// </summary>
class CloudbedsRequestCurrentGuests : CloudbedsAuthenticatedRequestBase
{
    ...
    */
    ...
    public List<CloudbedsGuest> ExecuteRequest_SinglePage(int pageNumber, int pageSize)
    {
        ...
        //Get the response
        //========================================================================
        var response = GetWebReponseLogErrors(httpRequest, "request hotel checked in guests list");
        ...
        using (response)
        {
            ...
            return ExecuteRequest_ParseGuestsFromReponse(jsonResult_dataNode);
        }
    }
    ...
    /// <returns></returns>
    private List<CloudbedsGuest> ExecuteRequest_ParseGuestsFromReponse(JsonElement jsonResult_dataNode)
    {
        ...
        {
            CloudbedsGuest? thisGuest = ExecuteRequest_ParseGuestsFromReponse_SingleGuest(jsonSingleGuest);
            if(thisGuest != null)
            {
    ...
    private CloudbedsGuest? ExecuteRequest_ParseGuestsFromReponse_SingleGuest(JsonElement jsonSingleGuest)
    {
        try
        {
            return ExecuteRequest_ParseGuestsFromReponse_SingleGuest_inner(jsonSingleGuest);
        }
        catch(Exception ex)
        {
    ...
    private CloudbedsGuest ExecuteRequest_ParseGuestsFromReponse_SingleGuest_inner(JsonElement jsonSingleGuest)
    {
        string guestId =
