...
{
    /// <summary>
    /// Mobile devices grant the application access to a specific working directiry
    /// (e.g. iOS, Android)
    /// </summary>
    public static string MobileDevice_WorkingDirectoryForApp
    {
        get
        {
    ...
    /// </summary>
    /// <returns></returns>
    public static string FilenameSegment_Timestamp()
    {
        ...
        now.Day.ToString("00") +
        "_" + System.Environment.TickCount.ToString();
    ...
    /// <summary>
    /// Characters we will do search/replace content names safe for the Windows file system
    /// </summary>
